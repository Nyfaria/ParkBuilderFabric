...
public class ExtractorMenu extends AbstractContainerMenu {
   ...
   public ExtractorMenu(int p_39532_, Inventory p_39533_, FriendlyByteBuf buf) {
      this(ContainerInit.EXTRACTOR_MENU, RecipeType.SMELTING, RecipeBookType.FURNACE, p_39532_, p_39533_);
   }
   public ExtractorMenu(MenuType<?> p_38960_, RecipeType<? extends AbstractCookingRecipe> p_38961_, RecipeBookType p_38962_, int p_38963_, Inventory p_38964_) {
      this(p_38960_, p_38961_, p_38962_, p_38963_, p_38964_, new SimpleContainer(3), new SimpleContainerData(4));
   }

   protected ExtractorMenu(MenuType<?> p_38966_, RecipeType<? extends AbstractCookingRecipe> p_38967_, RecipeBookType p_38968_, int p_38969_, Inventory p_38970_, Container p_38971_, ContainerData p_38972_) {
...
//      this.addSlot(new ExtractorSlot(this, p_38971_, 1, 56, 53));
   ...
   public ItemStack quickMoveStack(Player pPlayer, int pIndex) {
      ...
      if (slot != null && slot.hasItem()) {
         ...
         if (pIndex == 2) {
            ...
            } else if (pIndex >= 30 && pIndex < 38 && !this.moveItemStackTo(itemstack1, 3, 30, false)) {
               return ItemStack.EMPTY;
            }
