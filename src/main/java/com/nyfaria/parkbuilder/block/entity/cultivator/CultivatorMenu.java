...
public class CultivatorMenu extends AbstractContainerMenu {
   ...
   public CultivatorMenu(int p_39532_, Inventory p_39533_, FriendlyByteBuf buf) {
      this(ContainerInit.CULTIVATOR_MENU, RecipeType.SMELTING, RecipeBookType.FURNACE, p_39532_, p_39533_);
   }
   public CultivatorMenu(MenuType<?> p_38960_, RecipeType<? extends AbstractCookingRecipe> p_38961_, RecipeBookType p_38962_, int p_38963_, Inventory p_38964_) {
      this(p_38960_, p_38961_, p_38962_, p_38963_, p_38964_, new SimpleContainer(3), new SimpleContainerData(4));
   }

   protected CultivatorMenu(MenuType<?> p_38966_, RecipeType<? extends AbstractCookingRecipe> p_38967_, RecipeBookType p_38968_, int p_38969_, Inventory p_38970_, Container p_38971_, ContainerData p_38972_) {
